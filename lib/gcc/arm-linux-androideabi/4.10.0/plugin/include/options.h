...
enum opt_code
{
  ...
  OPT_mbionic = 1083,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1084,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1085,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1086,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1087,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1088,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1089,                  /* -mfp16-format= */
  OPT_mfpu_ = 1090,                          /* -mfpu= */
  OPT_mglibc = 1091,                         /* -mglibc */
  /* OPT_mhard_float = 1092, */              /* -mhard-float */
  OPT_mlittle_endian = 1093,                 /* -mlittle-endian */
  OPT_mlong_calls = 1094,                    /* -mlong-calls */
  OPT_mlra = 1095,                           /* -mlra */
  OPT_mneon_for_64bits = 1096,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1097,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1098,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1099,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1100,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1101,            /* -mpoke-function-name */
  OPT_mrestrict_it = 1102,                   /* -mrestrict-it */
  OPT_msched_prolog = 1103,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1104,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1105,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1106, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1107,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1108,                         /* -mthumb */
  OPT_mthumb_interwork = 1109,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1110,                  /* -mtls-dialect= */
  OPT_mtp_ = 1111,                           /* -mtp= */
  OPT_mtpcs_frame = 1112,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1113,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1114,                         /* -mtune= */
  OPT_muclibc = 1115,                        /* -muclibc */
  OPT_munaligned_access = 1116,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1117,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1118,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1119,              /* -mword-relocations */
  OPT_mwords_little_endian = 1120,           /* -mwords-little-endian */
  OPT_n = 1121,                              /* -n */
  ...
  OPT_std_gnu__1y = 1195,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1196,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1197,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1198, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1199, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1200,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1201,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1202, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1203, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1204,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1205, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1206, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1207, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1208,                     /* -std=legacy */
  OPT_symbolic = 1209,                       /* -symbolic */
  OPT_t = 1210,                              /* -t */
  OPT_time = 1211,                           /* -time */
  OPT_time_ = 1212,                          /* -time= */
  OPT_tno_android_cc = 1213,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1214,                 /* -tno-android-ld */
